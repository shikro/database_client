...
class Ui_reader_window(object):
    def setupUi(self, reader_window):
        ...
        self.all_events_table.setGeometry(QtCore.QRect(20, 20, 641, 201))
        ...
        self.all_events_table.horizontalHeader().setDefaultSectionSize(145)
        self.my_events_table = QtWidgets.QTableWidget(self.events_page)
        self.my_events_table.setGeometry(QtCore.QRect(20, 250, 641, 161))
        self.my_events_table.setObjectName("my_events_table")
        self.my_events_table.setColumnCount(5)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.my_events_table.setHorizontalHeaderItem(4, item)
        self.my_events_table.horizontalHeader().setDefaultSectionSize(145)
        ...
        self.label_8.setGeometry(QtCore.QRect(20, 230, 221, 16))
        self.label_8.setObjectName("label_8")
        self.toolBox.addItem(self.events_page, "")
        self.account_info_page = QtWidgets.QWidget()
        self.account_info_page.setGeometry(QtCore.QRect(0, 0, 98, 28))
    ...
    def retranslateUi(self, reader_window):
        ...
        item.setText(_translate("reader_window", "books"))
        item = self.my_events_table.horizontalHeaderItem(3)
        item.setText(_translate("reader_window", "date"))
