...
class Ui_reader_window(object):
    def setupUi(self, reader_window):
        ...
        self.events_page.setGeometry(QtCore.QRect(0, 0, 681, 429))
        self.events_page.setObjectName("events_page")
        self.all_events_table = QtWidgets.QTableWidget(self.events_page)
        self.all_events_table.setGeometry(QtCore.QRect(20, 20, 641, 161))
        self.all_events_table.setObjectName("all_events_table")
        self.all_events_table.setColumnCount(4)
        ...
        self.all_events_table.horizontalHeader().setDefaultSectionSize(150)
        self.events_refresh_button = QtWidgets.QPushButton(self.events_page)
        self.events_refresh_button.setGeometry(QtCore.QRect(500, 390, 131, 41))
        self.events_refresh_button.setObjectName("events_refresh_button")
        self.my_events_table = QtWidgets.QTableWidget(self.events_page)
        self.my_events_table.setGeometry(QtCore.QRect(20, 210, 641, 171))
        self.my_events_table.setObjectName("my_events_table")
        self.my_events_table.setColumnCount(4)
        self.my_events_table.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.my_events_table.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.my_events_table.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.my_events_table.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.my_events_table.setHorizontalHeaderItem(3, item)
        self.my_events_table.horizontalHeader().setDefaultSectionSize(150)
        self.label_7 = QtWidgets.QLabel(self.events_page)
        self.label_7.setGeometry(QtCore.QRect(30, 0, 81, 16))
        self.label_7.setObjectName("label_7")
        self.label_8 = QtWidgets.QLabel(self.events_page)
        self.label_8.setGeometry(QtCore.QRect(20, 190, 221, 16))
    ...
    def retranslateUi(self, reader_window):
        ...
        item.setText(_translate("reader_window", "theme"))
        item = self.all_events_table.horizontalHeaderItem(1)
        item.setText(_translate("reader_window", "speakers"))
        item = self.all_events_table.horizontalHeaderItem(2)
        item.setText(_translate("reader_window", "date"))
        self.events_refresh_button.setText(_translate("reader_window", "refresh"))
        item = self.my_events_table.horizontalHeaderItem(0)
        item.setText(_translate("reader_window", "theme"))
        item = self.my_events_table.horizontalHeaderItem(1)
        item.setText(_translate("reader_window", "speakers"))
        item = self.my_events_table.horizontalHeaderItem(2)
        item.setText(_translate("reader_window", "date"))
        self.label_7.setText(_translate("reader_window", "all events:"))
        self.label_8.setText(_translate("reader_window", "events that you have signed up for:"))
